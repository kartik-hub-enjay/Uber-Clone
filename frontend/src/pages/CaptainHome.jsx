...
const CaptainHome = () => {
    ...
    return (
        <div className='h-screen'>
            ...
            <div ref={ridePopupPanelRef} className='fixed inset-x-0 mx-auto max-w-107.5 w-full z-10 bottom-0 translate-y-full bg-white px-3 py-10 pt-12'>
                <RidePopUp
                    ride={ride}
            ...
            <div ref={confirmRidePopupPanelRef} className='fixed inset-x-0 mx-auto max-w-107.5 w-full h-screen z-10 bottom-0 translate-y-full bg-white px-3 py-10 pt-12'>
                <ConfirmRidePopUp
                    ride={ride}
